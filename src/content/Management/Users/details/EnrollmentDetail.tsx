    ...
    <Box width={'100%'}>
      ...
      <Typography>
        ...
        >
          ...
          <Typography
            sx={{ border: 1, width: '50%', borderRadius: '2px', p: 1 }}
          >
            238476
          </Typography>
        </Typography>
        ...
        >
          <Typography sx={{ width: '50%' }}>
            {' '}
            Mothly Disbursement(inr crores) :{' '}
          </Typography>
          <Typography
            sx={{ border: 1, width: '50%', borderRadius: '2px', p: 1 }}
          >
        ...
        >
          <Typography sx={{ width: '50%' }}>
            {' '}
            Last 6 Months GST Turnover (inr crores) :{' '}
          </Typography>
          <Typography
            sx={{ border: 1, width: '50%', borderRadius: '2px', p: 1 }}
          >
