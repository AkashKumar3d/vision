...
const CreateDealButton = ({ setList }) => {
  const [open, setOpen] = useState<boolean>(false);
  return (
    <Grid>
      <CreateForm open={open} setOpen2={setOpen} setList={setList} />
      <Box
        maxWidth={'100%'}
        sx={{
          color: '#ef8450',
      ...
      >
        ...
        >
          ...
          >
            <Typography
              variant="h3"
              style={{ fontWeight: 900, color: '#347362' }}
            >
              New Deal
            </Typography>
            <Typography
            ...
            >
              <label>
                Click the
                <span style={{ color: '#ef8450', letterSpacing: 3 }}>
                  {' '}
                  "Create New Deal"{' '}
                </span>
                button below to initiate the process and set up a new deal
                opportunity.
              </label>
              <br />
              <br />
