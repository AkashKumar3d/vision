  ...
  const handleEnrol = async (enrolType: string) => {
    try {
      ...
      let response = await axios.put(
        `http://localhost:3000/api/users/userEnrol?id=${id}`,
        data
      );
          ...
          >
            ...
            >
              ...
              <Typography
                ...
                lineHeight={1.7}
              >
                <label>Select your role below to enroll either</label>
                <br />
                <br />
                <label style={{ color: 'wheat', letterSpacing: 3 }}>
                  as a service provider (Supply) or as a consumer seeking
                  services (Demand).
                </label>
